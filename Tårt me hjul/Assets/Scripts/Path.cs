    ...
    public bool IsClosed {
        ...
        set {
            if (isClosed != value)
            {
                ...
                if (isClosed)
                {
                    points.Add(points[points.Count - 1] * 2 - points[points.Count - 2]); // Adds new control point by looking at corresponding controlpoint
